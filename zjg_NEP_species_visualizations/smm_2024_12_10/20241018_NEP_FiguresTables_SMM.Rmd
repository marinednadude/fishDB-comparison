...
write.table(collapsedPhylum_df, 
            file = here("zjg_NEP_species_visualizations","smm_2024_12_10","collapsedUniquePhyla_mitogenomeDirectResults.txt"), 
...
collapsedPhylum_df <- FINAL_SPECIES_DB %>%
  ...
  collapse_by_phylum_strings()
write.table(collapsedPhylum_df, 
            file = here("zjg_NEP_species_visualizations","smm_2024_12_10","collapsedUniquePhyla_mitogenomeSubtreeResults.txt"), 
            sep = '\t', quote = FALSE, row.names = FALSE, col.names = TRUE)
...
collapsedPhylum_df <- FINAL_SPECIES_DB %>%
  ...
  collapse_by_phylum_strings()
write.table(collapsedPhylum_df, 
            file = here("zjg_NEP_species_visualizations","smm_2024_12_10","collapsedUniquePhyla_sraDirectResults.txt"), 
            sep = '\t', quote = FALSE, row.names = FALSE, col.names = TRUE)
...
collapsedPhylum_df <- FINAL_SPECIES_DB %>%
  ...
  collapse_by_phylum_strings()
write.table(collapsedPhylum_df, 
            file = here("zjg_NEP_species_visualizations","smm_2024_12_10","collapsedUniquePhyla_sraSubtreeResults.txt"), 
            sep = '\t', quote = FALSE, row.names = FALSE, col.names = TRUE)
