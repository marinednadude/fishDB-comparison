...
write.table(CCLME_list_assembled_clean_NOT_SEARCHING_NCBI, file=here("gap_analysis_code","00_scripts","fishcard_attempt","CCLME_list_assembled_clean_gtGenus_NOT_SEARCHING_NCBI.txt"), sep='\t', quote=FALSE, row.names=FALSE, col.names = TRUE)
write.table(remaining_records, file=here("gap_analysis_code","00_scripts","fishcard_attempt","scientificNameTable_gtGenus_NOT_SEARCHING_NCBI.txt"), sep='\t', quote=FALSE, row.names=FALSE, col.names = TRUE)
```
...
write.table(CCLME_list_assembled_clean_GENUS_NOT_SEARCHING_NCBI, file=here("gap_analysis_code","00_scripts","fishcard_attempt","CCLME_list_assembled_clean_GenusNoNCBI_NOT_SEARCHING_NCBI.txt"), sep='\t', quote=FALSE, row.names=FALSE, col.names = TRUE)
write.table(Genus_noNCBIid, file=here("gap_analysis_code","00_scripts","fishcard_attempt","scientificNameTable_GenusNoNCBI_NOT_SEARCHING_NCBI.txt"), sep='\t', quote=FALSE, row.names=FALSE, col.names = TRUE)
```
...
#   ungroup()
# 
File02_taxonomy_names_search <- read_delim(here("gap_analysis_code","00_scripts","fishcard_attempt","NCBI_search/names/NCBI_taxonomy_02_species_noNCBI_names_search_combined.txt"), col_types = "c", na = c("","NA"), col_names = c("NCBITaxId", "NCBIAkaTaxId", "NCBIStatus", "NCBIRank", "Scientific.Name", "NCBIGenus", "NCBISpecies", "NCBIModificationDate"))
...
subtree_path <- "/Users/zgold/Documents/GitHub/fishDB-comparison/NEP_share/20241210_Current_NEP_gap_analysis/00_scripts/taxi"
nodes_dmp_path <- "/Users/zgold/Documents/UCLA_download_20240702/combined/Takeout/Drive/My_MacBook_Pro/Documents/UCLA_phd/Projects/anacapa/CRUX_2.0/rcrux/nodes.dmp"
identifier_input_file <- here("gap_analysis_code","00_scripts","fishcard_attempt","NCBI_search/taxIDs/taxids_identifier_onePerLine.txt")
accepted_input_file <- here("gap_analysis_code","00_scripts","fishcard_attempt","NCBI_search/taxIDs/taxids_accepted_onePerLine.txt")
identifier_output_file <- here("gap_analysis_code","00_scripts","fishcard_attempt","NCBI_search/taxIDs/subtree_identifier_taxids.txt")
accepted_output_file <- here("gap_analysis_code","00_scripts","fishcard_attempt","NCBI_search/taxIDs/subtree_accepted_taxids.txt")
...
```{r}
File03_taxid_search <- read_delim(here("gap_analysis_code","00_scripts","fishcard_attempt","NCBI_search/taxIDs/NCBI_output_03_species_singleNCBI_taxID_search_nucl_combined.txt"), col_types = "c", na = c("","NA"), col_names = c("AccessionVersion", "Title", "CreateDate", "Organism", "TaxId", "MolType", "Genome", "Completeness", "Topology", "Slen", "SubType", "SubName"))

File03_sra_search <- read_csv(here("gap_analysis_code","00_scripts","fishcard_attempt","NCBI_search/taxIDs/NCBI_output_03_species_singleNCBI_taxID_search_sra_combined.txt"), col_types = cols(.default = col_character()), na = c("","NA"), col_names = TRUE)
